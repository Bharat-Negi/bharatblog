...
import HomePageTitle from "../page-title/HomePageTitle";

export default function BusinessPage() {
  return (
    <section className="business-category section">
      <HomePageTitle heading="Business" link="/" />
        ...
        <div className="row">
          <div className="col-md-9 order-md-2">
            <div className="d-lg-flex post-entry">
              ...
              >
                <img
                  src="/images/post-landscape-3.jpg"
                  alt=""
                  className="img-fluid"
                />
              </a>
            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="post-list border-bottom">
                  <a href="blog-details.html">
                    <img
                      src="/images/post-landscape-5.jpg"
                      alt=""
                      className="img-fluid"
                    />
                  </a>
              ...
              <div className="col-lg-8">
                <div className="post-list">
                  <a href="blog-details.html">
                    <img
                      src="/images/post-landscape-7.jpg"
                      alt=""
                      className="img-fluid"
                    />
                  </a>
