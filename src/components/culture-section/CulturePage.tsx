...
export default function CulturePage() {
  return (
    <section className="culture-category section">
      <HomePageTitle heading="Culture" link="/" />
        ...
        <div className="row">
          <div className="col-md-9">
            <div className="d-lg-flex post-entry">
              ...
              >
                <img
                  src="/images/post-landscape-6.jpg"
                  alt=""
                  className="img-fluid"
                />
              </a>
            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="post-list border-bottom">
                  <a href="blog-details.html">
                    <img
                      src="/images/post-landscape-1.jpg"
                      alt=""
                      className="img-fluid"
                    />
                  </a>
              ...
              <div className="col-lg-8">
                <div className="post-list">
                  <a href="blog-details.html">
                    <img
                      src="/images/post-landscape-2.jpg"
                      alt=""
                      className="img-fluid"
                    />
                  </a>
